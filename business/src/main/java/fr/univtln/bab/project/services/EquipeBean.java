...
public class EquipeBean {
    ...
    public Equipe getEq(){return equipe;}
    public Equipe getEquipe(int id){
        return equipeDAO.find(id);
    }
    public List<Equipe> getEquipes(){
        return equipeDAO.findAll();
    }
    public void ajouterEquipe(Equipe equipe){
        equipeDAO.persist(equipe);
    }

    public void modifierEquipe(Equipe equipeUpdated){
        equipeDAO.update(equipeUpdated);
    }
